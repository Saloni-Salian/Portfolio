...
<aside id="deleteposts">
            <form id="deleteform"action="deleteBlog.php" method="POST" >
                <fieldset class="main">
                    <h3>Delete</h3>
                    <p>Please enter the blog title that you wish to delete</p>
                    <p> 
                        <input class="deletetitle" type="text" placeholder="Title" name="title" required>
                    </p>
                    <p class="buttons">
    ...
    <div id=middle>
        <section id=month>
            <form id="amonthform" action="adminViewBlog.php" method="POST">
        ...
        <section id ="acomments">
            <?php
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    <p>Title:" . $row['Title']. "</p>
                    <p>Body: " . $row['Body'] . " </p>
                    <p  class='try'>DateTime: " . $row['Time'] . " </p>";  
                }
            ?>
        </section>
        <br>
    ...
    <aside id ="deletecomments">
            <form id="deleteform" action="deleteComment.php" method="POST" >
                <fieldset class="main">
                    <h3>Delete</h3>
                    <p>Please enter the comment title that you wish to delete</p>
                    <p> 
                        <input class="deletetitle" type="text" placeholder="Title" name="title" required>
                    </p>
                    <p class="buttons">
